...
export class CaptchaComponent implements OnChanges {
  ...
  constructor(private captchService:CaptchaService ,private formBuilder: FormBuilder){
  ...
  ngOnInit(){
    ...
    this.captchaForm = this.formBuilder.group({
      ...
      console.log(this.captchaForm.controls['captcha'].errors)
      console.log(this.captchaForm.controls['captcha'].errors['required'])
